...
import {Form as RSForm, FormGroup as RSFormGroup, Label as RSLabel, Col as RSCol, Input as RSInput} from 'reactstrap';
...
<RSForm>
        <RSFormGroup>
          ...
          <Input  id={XShipVia.kShipVia_Ship_Via_Name} placeholder="Ship via Name" value={StringChecker(this.state.item.Ship_Via_Name)}
  ...
  <Form name="DetailForm1" id="DetailForm1"  >
    <Row>                    
                    <Col sm={12} lg={4} md={4}>
                    <FormItem
                        label="Name"

...
class NetworkListView extends React.Component <INetworkListViewProps,INetworkListViewState>{
    ...
    public render() {
      ...
      let itemList = network.networkList;
      if (this.state.activeOnly)
      {
      ...
      itemList = itemList.map((item) =>
        <NetworkView key={item.Id} itemId={item.Id} item={item} isNew={false} />
      );
      ...
      return (
        <div>
          ...
          <Modal isOpen={this.state.modal} toggle={this.toggleModal}>
            <ModalHeader toggle={this.toggleModal}>Add New Network</ModalHeader>
            <ModalBody>
              <NetworkView itemId={this.state.newItem.Id} item={this.state.newItem} isNew={true} toggleModal={this.toggleModal} />
            </ModalBody>
          </Modal>

...
export const databaseAdd = (database:Database) => {
    return {
        type: DATABASE_ADD,
        payload: database
    };
...
export const databaseAddSuccess = (database:Database) => {
    return {
...
export const databaseUpdate = (database:Database) => {
    return {
...
export const databaseUpdateSuccess = (database:Database) => {
    return {
...
export const databaseDelete = (database:Database) => {
    return {
...
export const databaseDeleteSuccess = (database:Database) => {
    return {

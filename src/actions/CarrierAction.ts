...
export const carrierGetAllSuccess = (carrierList:ShipViaModel[]) => {
    return {
...
export const carrierAdd = (carrier:ShipViaModel) => {
    return {
        type: CARRIER_ADD,
        payload: carrier
    };
...
export const carrierAddSuccess = (carrier:ShipViaModel) => {
    return {
...
export const carrierUpdate = (carrier:ShipViaModel) => {
    return {
        type: CARRIER_UPDATE,
        payload: carrier
    };
...
export const carrierUpdateSuccess = (carrier:ShipViaModel) => {
    return {
...
export const carrierDelete = (carrier:ShipViaModel) => {
    return {
        type: CARRIER_DELETE,
        payload: carrier
    };
...
export const carrierDeleteSuccess = (carrier:ShipViaModel) => {
    return {

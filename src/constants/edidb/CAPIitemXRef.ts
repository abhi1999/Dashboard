...
export const kAPIitemXRef_TP_Name="TP_Name";
export const kAPIitemXRef_Int_Item_No="Int_Item_No";
export const kAPIitemXRef_TP_PartID="TP_PartID";
export const kAPIitemXRef_Cust_Item_Qual="Cust_Item_Qual";
export const kAPIitemXRef_Cust_Item_ID="Cust_Item_ID";
export const kAPIitemXRef_Cust_Item_UM="Cust_Item_UM";
export const kAPIitemXRef_Cust_Item_SizeWidth="Cust_Item_SizeWidth";
export const kAPIitemXRef_Cust_Item_Pack_Qty="Cust_Item_Pack_Qty";
export const kAPIitemXRef_Cust_Item_UMout="Cust_Item_UMout";
export const kAPIitemXRef_Cust_Item_UMfactor="Cust_Item_UMfactor";
export const kAPIitemXRef_Cust_Item_UMoperin="Cust_Item_UMoperin";
export const kAPIitemXRef_Cust_Item_UMoperout="Cust_Item_UMoperout";
export const kAPIitemXRef_pricecode="pricecode";
export const kAPIitemXRef_price="price";
export const kAPIitemXRef_locid="locid";
export const kAPIitemXRef_ICID="ICID";
export const kAPIitemXRef_GenericRef="GenericRef";
export const kAPIitemXRef_User1="User1";
export const kAPIitemXRef_User2="User2";
export const kAPIitemXRef_User3="User3";
export const kAPIitemXRef_User4="User4";
export const kAPIitemXRef_User5="User5";
export const kAPIitemXRef_Loc_Override="Loc_Override";
